...
export const parseToReadableFormat = ({ total, expenses }) => {
  return {
    total: convertToNorwegianPrice(total),
    expenses: convertToNorwegianPrice(expenses),
  };
};

export const parseInteger = ({ total, expenses }) => {
  return {
    total: convertToNorwegianPrice(total),
    expenses: convertToNorwegianPrice(expenses),
  };
...
export const splitPrices = ({ adress, price }) => {
